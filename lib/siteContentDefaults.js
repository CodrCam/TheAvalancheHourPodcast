...
import {
  normalizeHomeContent as normalizeHomeContentWithDefaults,
...
export const DEFAULT_HOME_CONTENT = {
  ...
  featuredLinkUrl: SOCIAL_LINKS.instagram,
  donateEnabled: true,
  donateButtonLabel: 'Donate to the Podcast',
  donateButtonUrl: SUPPORT_LINKS.paypalDonate,
};

export function normalizeHomeContent(value = {}) {
  return normalizeHomeContentWithDefaults(value, DEFAULT_HOME_CONTENT);
}
