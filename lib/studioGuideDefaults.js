...
- The introduction, show notes, guest links, social copy, music information, and credits are complete.
...
Avoid “use the good part,” “fix this section,” “latest file,” or “cut the awkward bit.” If two reasonable producers could interpret the note differently, make it more specific.`,
    ...
    },
    {
      ...
      category: 'Deliver',
      title: 'Write the introduction, show notes, social copy, and credits',
      summary:
        'Give the producer a coherent publishing package that reflects the episode instead of a pile of disconnected promotional assets.',
      body: `The written package should make one promise across the introduction, show notes, social copy, and images. Each format has a different job, but all of them should point toward the same story.
...
## Outro
Credit the producer, music, artwork, photography, and other creative work. Include the current subscribe, feedback, survey, social, and next-episode language requested by the team.

## Show notes
Write two or three human paragraphs that explain the story and why it matters. Add a concise guest biography, the primary topics, and relevant organization or research links. Do not paste an unedited transcript or generic artificial summary.

## Social package
Provide a concise guest-and-story summary, two to four useful takeaways, correct host and guest handles, and any no-tag request. A strong excerpt can be suggested with an exact timestamp.
...
6. Confirm the introduction, show notes, social copy, music, and credits are complete.
