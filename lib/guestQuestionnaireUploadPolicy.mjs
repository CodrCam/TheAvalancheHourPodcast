...
export function getGuestQuestionnaireUploadMutationLock(
  questionnaireValue = {}
) {
  const responseStatus = safeId(
    questionnaireValue?.response?.status,
    60
  );
  if (responseStatus === 'update_requested') {
    return {
