...
export const STUDIO_RESOURCE_VIDEO_PATHS = [
  'host',
  'production',
  'operations',
];
...
export function normalizeStudioResourceVideo(value = {}, index = 0) {
  ...
  return {
    ...
    resource_path: cleanText(value.resource_path, 40) || 'host',
  };
}
...
export function validateStudioResourceVideoReference(value = {}) {
  ...
  if (!STUDIO_RESOURCE_VIDEO_PATHS.includes(video.resource_path)) {
    throw new Error('Resource video: the resource path is invalid.');
  }
  if (
