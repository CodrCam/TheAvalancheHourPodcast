    ...
    steps: [
      {
        ...
        action: 'Open Host Studio',
        permission: 'episodes:read',
        description:
          'Begin in Host Studio so you know the story assignment, release date, host-package deadline, sponsor requirements, and what the production team expects before you schedule anything.',
        use_for:
        ...
        instructions: [
          'Open Host Studio and select the episode assigned to you.',
    ...
    faqs: [
      {
        ...
        answer:
          'Open Host Studio, choose the assigned episode, and use its Episode Studio as the shared source for guest details, requirements, files, and discussion.',
        href: '/studio/episodes',
        action: 'Open Host Studio',
        permission: 'episodes:read',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'The operating desk for choosing a case from the explicit eligible-kit picker, saving shipping presets, exporting a Pirate Ship-ready spreadsheet for US home-base shipments, creating direct handoffs one at a time, recording tracking, and checking kits back in.',
        use_for:
          'Use only when you are responsible for the physical movement and custody record. Non-US-origin shipments remain a manual carrier workflow.',
        handoff:
      ...
      },
      {
        ...
        action: 'Open Schedule & assignments',
