...
export const STUDIO_PREVIEW_HREF_MAP = Object.freeze({
  ...
  '/studio/manage/episodes': '/dev/schedule-assignments-preview',
  ...
  '/studio/resources': '/dev/resource-video-preview',
  '/studio/profile': '/dev/today-preview',
  '/studio/mic-kits': '/dev/mic-kit-status-preview',
  '/studio/notifications': '/dev/notification-preview',
